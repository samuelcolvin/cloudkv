/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8ec64f2c1107bad6268ce7b3cd4eca1c)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_SHA" | "LOGFIRE_TOKEN">> {}
}
